...
export default function App() {
  const [view, setView] = useState<'home' | 'open-ticket' | 'login' | 'dashboard' | 'ticket-detail' | 'users' | 'ticket-success' | 'loans-menu' | 'loan-request' | 'loan-tracking' | 'loans-dashboard' | 'patrimonio-dashboard' | 'ticket-tracking'>('home');
  ...
  const HomeView = () => {
    const buttons = [
      ...
      { id: 'scheduling-external', label: 'Agendamento', icon: Calendar, color: 'bg-slate-700', url: 'https://chavesporto.vercel.app' },
    ...
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 relative overflow-hidden">
        ...
        >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-8 gap-4 lg:gap-2 xl:gap-4">
            {buttons.map((btn) => {
              const content = (
                <>
